...
This repository is based on the the book and the codes of *Modern Graph Theory Algorithms with Python* by **Colleen M. Farrelly** and **Franck Kalala Mutombo**. 
...
In this project, I **expand on their code examples**, add **visualizations**, and provide **summarized explanations** drawn both from the book and from **external research sources** using chatGPT and my own edits.